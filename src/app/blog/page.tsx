            ...
            <Section className="-mt-8">
              <Card interactive>
                <div className="flex items-center gap-3">
                  <span className="rounded-full bg-sunbeam/20 px-3 py-1 text-xs font-bold text-ink">
                    Featured
                  </span>
              ...
              {regular.map((post) => (
                <Card key={post.id} interactive>
                  <div className="flex items-center gap-2">
                    <span className="rounded-full bg-paper px-2.5 py-0.5 text-xs font-bold text-ink-soft capitalize">
                      {post.category}
                    </span>
